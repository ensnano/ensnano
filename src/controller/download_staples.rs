...
fn get_design_providing_staples(downloader: &dyn StaplesDownloader) -> Box<dyn AutomataState> {
...
fn download_staples(downloader: &dyn StaplesDownloader, path: PathBuf) -> Box<dyn AutomataState> {
