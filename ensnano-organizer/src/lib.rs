...
/// Messages generated by an Organizer.
#[derive(Clone, Debug)]
...
#[derive(Clone, Debug)]
pub struct InternalMessage<E: OrganizerElement>(_Message<E>);

/// Internal messages
#[derive(Clone, Debug)]
enum _Message<E: OrganizerElement> {
    Expand {
...
impl<E: OrganizerElement> OrganizerMessage<E> {
    ...
    fn node_selected(id: NodeId<E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::NodeSelected { id }))
    }

    fn node_hovered(id: NodeId<E::AutoGroup>, hovered_in: bool) -> Self {
        Self::InternalMessage(InternalMessage(_Message::NodeHovered { id, hovered_in }))
    }

    fn key_hovered(key: E::Key, hovered_in: bool) -> Self {
        Self::InternalMessage(InternalMessage(_Message::KeyHovered { key, hovered_in }))
    }

    fn edit(id: NodeId<E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::Edit { id }))
    }

    fn delete(id: NodeId<E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::Delete { id }))
    }

    fn name_input(name: String) -> Self {
        Self::InternalMessage(InternalMessage(_Message::NameInput { name }))
    }

    fn stop_edit() -> Self {
        Self::InternalMessage(InternalMessage(_Message::StopEdit))
    }

    fn element_selected(key: E::Key) -> Self {
        Self::InternalMessage(InternalMessage(_Message::ElementSelected { key }))
    }

    fn add_selection_to_group(id: NodeId<E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::AddSelectionToGroup { id }))
    }

    fn new_group() -> Self {
        Self::InternalMessage(InternalMessage(_Message::NewGroup))
    }

    fn dragging(key: DragIdentifier<E::Key, E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::Dragging(key)))
    }

    fn drag_dropped(key: DragIdentifier<E::Key, E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::DragDropped(key)))
    }

    fn attribute_selected(attribute: E::Attribute, id: NodeId<E::AutoGroup>) -> Self {
        Self::InternalMessage(InternalMessage(_Message::AttributeSelected {
            attribute,
            id,
        }))
    }
...
impl<E: OrganizerElement> Organizer<E> {
    ...
    pub fn message(
        ...
        match &message.0 {
            ...
            _Message::NameInput { name } => self.edit_name(name.clone()),
            _Message::StopEdit => {
                self.stop_editing();
                return Some(OrganizerMessage::NewTree(self.tree()));
            }
            _Message::ElementSelected { key } => {
            ...
            _Message::AddSelectionToGroup { id } => {
