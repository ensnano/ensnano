...
/// A setup that makes helices a single body. The simplest
/// simulations, which does not have much use.
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
/// With this setup, helices are single rigid bodies at first,
/// which are then cut at crossover points.
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
